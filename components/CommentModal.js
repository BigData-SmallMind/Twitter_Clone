...
import { modalState, postIdState, currentUserState } from "../atom/modalAtom";
        ...
        >
          <div className="p-1">
            ...
            <div className="p-2 flex items-center space-x-1 relative">
              <span className="w-0.5 h-full z-[-1] absolute left-8 top-11 bg-gray-300 truncate" />
              <img
          ...
          {/* <div className="">
            <div className="over over">
              {Object.entries(currentUser).map((key) => {
                return <div>{`${key}`}</div>;
              })}
            </div>
          </div> */}
