...
const Feed = () => {
  ...
  return (
    <div className="xl:ml-[320px] border-l border-r border-gray-200  xl:min-w-[576px] sm:ml-[73px] flex-grow max-w-xl">
      ...
      <Input postLoading={postLoading} />
      <Posts posts={posts} liftedLoadingState={liftedState} />
    </div>
  );
};
